...
description: "Gera um componente de lista standalone usando po-page-dynamic-search de @po-ui/ng-templates — o padrão Protheus para "
---
...
<PreviewModal src="/poui-specialist-docs/previews/templates-page-dynamic-search.svg" label="Ver como fica a tela" />
...
export class {{ComponentClass}} implements OnInit {
  ...
  // TODO: defina as colunas; use type:'label' + labels:[{value,color,label}] para campos de status
  readonly columns: PoTableColumn[] = [];

  // TODO: defina os filtros de busca avançada (painel lateral); gridColumns 1-12
