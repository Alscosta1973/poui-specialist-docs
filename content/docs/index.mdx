...
- **Geração de código** — templates prontos para page-list, page-edit, modal-crud, stepper, dashboard e mais 18 tipos
...
| **Comandos** | `/generate`, `/test`, `/docs`, `/review` |
| **Templates** | 28 templates de geração de código |
