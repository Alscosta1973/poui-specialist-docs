...
- **Geração de código** — templates prontos para page-list, page-edit, modal-crud, stepper, dashboard e mais 12 tipos
- **Testes unitários** — specs Karma + Jasmine para componentes e services, cobrindo smoke, HTTP, router e interações
...
| **Comandos** | `/generate`, `/test`, `/docs`, `/review`, `/connect` |
| **Templates** | 17 templates de geração de código |
...
- [/test](/docs/comandos/test) — gerar spec Karma + Jasmine para um componente
