...
<PreviewModal src="/poui-specialist-docs/previews/component-button.svg" label="Veja como fica a tela" />
...
<PreviewModal src="/poui-specialist-docs/previews/component-search.svg" label="Veja como fica a tela" />
...
<PreviewModal src="/poui-specialist-docs/previews/component-menu-header-template.svg" label="Veja como fica a tela" />
...
Painel de navegação lateral compacto — ícone-only quando recolhido, ícone + label quando expandido.
Ideal quando o espaço horizontal é limitado ou para apps com poucos itens de navegação.
...
<PreviewModal src="/poui-specialist-docs/previews/component-menu-panel.svg" label="Veja como fica a tela" />
...
<PreviewModal src="/poui-specialist-docs/previews/component-breadcrumb.svg" label="Veja como fica a tela" />
...
<po-page-edit p-title="Editar Pedido" [p-breadcrumb]="breadcrumb">
  ...
</po-page-edit>
```
...
> **Seleção e expansão:** `p-selected` e `p-expanded` nos itens controlam o estado inicial.
> Para seleção programática, atualize o array com `signal()` — não existe método `select()`.

<PreviewModal src="/poui-specialist-docs/previews/component-tree-view.svg" label="Veja como fica a tela" />
```
