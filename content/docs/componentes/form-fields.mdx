...
description: "Todos os campos abaixo funcionam com Angular Reactive Forms (formControlName) e Template-driven Forms."
---
...
inputs/outputs (confirmado em teste real). Veja exemplos já validados dessa forma separada nas páginas
de padrões de busca e i18n.
